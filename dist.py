...
def main():
    xf = st.sidebar.slider('Feed Concentration (xf)', .04, .95, .45)
    xw = st.sidebar.slider('Bottoms concentration (xw)', .04, .95, .058)
    yd = st.sidebar.slider('Top concentration (yd)', .04, .95, .9)
    rv= st.sidebar.slider('Relative volatality', 1.7, 10.0, 3.0)
